...
/// </summary>
/// <param name="arrayContext">The array that was modified.</param>
/// <param name="addedIndex">Zero-based index of the newly added item.</param>
/// <param name="form">The form context.</param>
...
/// </summary>
/// <param name="arrayContext">The array that was modified.</param>
/// <param name="removedIndex">Zero-based index the item occupied before removal.</param>
/// <param name="form">The form context.</param>
...
/// </summary>
/// <param name="arrayContext">The array that was modified.</param>
/// <param name="fromIndex">Zero-based index the item was dragged from.</param>
/// <param name="toIndex">Zero-based index the item was dropped at.</param>
/// <param name="form">The form context.</param>
...
public sealed class JsonFormContextOptions
{
    ...
    /// and this <see cref="JsonFormContextOptions"/> instance outlives it.
    /// </summary>
    ...
    /// <summary>
    /// Fired after a new item has been appended to an <c>ArrayLayout</c>.
    /// Subscribe with +=. Multiple handlers are supported.
    /// </summary>
